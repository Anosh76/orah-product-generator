...
export default function App() {
  ...
  const [learningExamples, setLearningExamples] = useState([
    { stone: 'Lapis Lazuli', product: 'Earring', desc: 'Unearth the celestial with these stunning drop earrings, featuring raw-cut Lapis Lazuli from Afghanistan, revered for its deep blue hue and pyrite \'star\' inclusions. Part of the Orah Jewels collection, the design is a tribute to Sadequain\'s mastery, pairing the organic, powerful stone with a bold, geometric brass stud. This handcrafted piece is more than jewelry; it\'s wearable art that captures the essence of thought and form, a striking statement connecting ancient Afghan heritage with modern artistic expression.' },
    { stone: 'Black Jasper', product: 'Ring', desc: 'Bold, powerful, and timeless—this Black Jasper ring is crafted for those who appreciate strength in simplicity. The design features a striking emerald-cut gemstone, known for its deep, grounding energy, set in a sleek band. The band is accented with a textured pattern on the sides, adding detail and sophistication while keeping the focus on the bold central stone. Black Jasper is celebrated as a stone of protection, courage, and stability—making this ring not only a style statement but also a meaningful talisman. At Orah Jewels & Crafts, each piece is the result of masterful craftsmanship—blending locally sourced gemstones with contemporary metalwork to create jewelry that carries both cultural heritage and modern design.' },
    { stone: 'Rose Quartz', product: 'Necklace', desc: 'A graceful ode to tenderness and love, this handcrafted necklace features soft, milky Rose Quartz suspended in a refined setting. The gentle pink tones of the quartz evoke warmth and compassion, while the delicate metalwork reflects Orah Jewels\' commitment to refined design and artisanal technique. Perfect for those who appreciate meaningful details and timeless gemstone jewelry, this pendant is more than an accessory—it\'s a reflection of light, emotion, and artistic expression. Whether styled for a special occasion or cherished as everyday elegance, this piece brings a whisper of grace to any collection.' },
  ]);
